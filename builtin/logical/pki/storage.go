...
func genKeyIssuerUUID() string {
	newId, err := uuid.GenerateUUID()
	if err != nil {
		panic("uuid generation failed unexpectedly: " + err.Error())
	}
...
func importKey(ctx context.Context, s logical.Storage, keyValue string) (*key, error) {
	...
	var result key
	result.ID = keyId(genKeyIssuerUUID())
...
func importIssuer(ctx context.Context, s logical.Storage, certValue string) (*issuer, error) {
	...
	// storage.
	var result issuer
	result.ID = issuerId(genKeyIssuerUUID())
