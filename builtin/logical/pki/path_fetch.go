...
hyphen-separated octal`,
		...
		Callbacks: map[logical.Operation]framework.OperationFunc{
			logical.ReadOperation: b.pathFetchCertificateRawHelper,
		},
...
func (b *backend) pathFetchCertificateRawHelper(ctx context.Context, req *logical.Request, data *framework.FieldData) (*logical.Response, error) {
	var serial, pemType, contentType string
